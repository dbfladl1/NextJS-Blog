...
export const PostCard = ({ post, refreshHandler }: PostCardProps) => {
  ...
  return (
    <div className="relative inline-block paper-flutter bg-[#fbf7efda] h-[300px] shadow-[1px_1px_0px_#d1cfc9] border border-[#e0ded9] p-5 pt-10 w-[calc(33.333%-1rem)] min-w-[200px] rotate-[0.7deg]">
      ...
      <p className="text-md text-gray-700">{post.text}</p>
