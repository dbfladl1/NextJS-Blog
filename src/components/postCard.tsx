...
export const PostCard = ({ post, refreshHandler }: PostCardProps) => {
  ...
  return (
    <div className="relative inline-block paper-flutter bg-[#fbf7efda] sm:max-h-[300px] sm:h-[300px] h-full  scroll-auto shadow-[1px_1px_0px_#d1cfc9] border border-[#e0ded9] p-5 pt-10 sm:w-[calc(33.333%-1rem)] w-full sm:min-w-[200px] rotate-[0.7deg]">
